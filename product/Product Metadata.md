...
| [02 BRD](02_BRD.md) | `product/02_BRD.md` | 1.3 | Approved — Konsep domain, aktor/RBAC, canonical status vocabulary, H-5 gate, financial rules, dan alur BPMN |
| [03 Feature Catalog & Scope](03_FEATURE_CATALOG_AND_SCOPE.md) | `product/03_FEATURE_CATALOG_AND_SCOPE.md` | 1.0 | Approved — Master katalog kapabilitas & pemetaan fase rilis (MVP vs. Phase 2 & 3) |
...
| Document Name | Path | Current Doc Version | Description / Status |
| :--- | :--- | :--- | :--- |
| [00 Domain Model](../technical/00_DOMAIN_MODEL.md) | `technical/00_DOMAIN_MODEL.md` | 1.0 | Approved — Conceptual & Functional Domain Model, Invariants & Bounded Contexts |
